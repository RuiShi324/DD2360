...
int main(int argc, char **argv) {
    ...
    cudaMemPrefetchAsync(umA, numARows * numAColumns * sizeof(DataType), device, NULL);
    cudaMemPrefetchAsync(umB, numBRows * numBColumns * sizeof(DataType), device, NULL);
    cudaMemPrefetchAsync(umC, numCRows * numCColumns * sizeof(DataType), device, NULL);
